...
k_schd uint4[20] key_schedule(uint4[20] key) {
    uint4[10] a = View(key, 0, 9);
    uint4[10] b = View(key, 10, 19);
    a = a <<< 2;
    b = b <<< 2;
    uint4[10] a1 = b;
    uint4[10] b1 = a ^ b;
    ...
    uint4 sbox_in1 = rtn[12];
    uint4 sbox_in2 = rtn[13];
    uint4 sbox_in3 = rtn[14];
    uint4 sbox_in4 = rtn[15];
...
r_fn uint4[16] round_function1(uint8 r, uint4[20] key, uint4[16] input) {
	uint4[16] n_input;
	for (i from 0 to 15) {
