...
pbox uint[16] pt = {9, 15, 8, 13, 10, 14, 12, 11, 0, 1, 2, 3, 4, 5, 6, 7};

k_schd uint4[32] key_schedule(uint4[32] key) {
    uint4[16] tk1 = View(key, 0, 15);
    uint4[16] tk2 = View(key, 16, 31);
    tk1 = pt<tk1>;
    tk2 = pt<tk2>;
    uint4[4] lfsr1;
    uint4[4] lfsr2;
...
# SKINNY 似乎不适用于word-wise，有点忘记了，这里的round function是有问题的。
