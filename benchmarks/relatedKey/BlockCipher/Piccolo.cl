...
k_schd uint1[64] key_schedule1(uint1[80] key) {
...
k_schd uint1[32] key_schedule2(uint1[80] key) {
    uint1[16] k0 = View(key, 0, 15);
    uint1[16] k1 = View(key, 16, 31);
    uint1[16] k2 = View(key, 32, 47);
    uint1[16] k3 = View(key, 48, 63);
...
k_schd uint1[32] key_schedule3(uint1[80] key) {
    uint1[16] k0 = View(key, 0, 15);
    uint1[16] k1 = View(key, 16, 31);
    uint1[16] k2 = View(key, 32, 47);
    uint1[16] k3 = View(key, 48, 63);
...
k_schd uint1[32] key_schedule4(uint1[80] key) {
    uint1[16] k0 = View(key, 0, 15);
    uint1[16] k1 = View(key, 16, 31);
    uint1[16] k2 = View(key, 32, 47);
    uint1[16] k3 = View(key, 48, 63);
...
fn uint1[64] enc(uint1[80] key, uint1[64] r_plaintext){
    uint1[64] wk = key_schedule1(key);
    r_plaintext = round_function1(1, View(wk, 0, 31), r_plaintext);

    uint1[32] rk02 = key_schedule2(key);
    uint1[32] rk14 = key_schedule3(key);
    uint1[32] rk3 = key_schedule4(key);
    for (i from 0 to 3) {
    ...
    r_plaintext = round_function1(27, View(wk, 32, 63), r_plaintext);
    return r_plaintext;
}