...
sbox uint4[16] s9 = {8, 7, 14, 5, 15, 13, 0, 6, 11, 12, 9, 10, 2, 4, 1, 3};
sbox uint4[16] s10 = {11, 5, 15, 0, 7, 2, 9, 13, 4, 8, 1, 12, 14, 10, 3, 6};
...
k_schd uint1[80] key_schedule(uint1[80] key) {
    uint1[80] key_lsh = key <<< 29;
    uint1[4] sbox_in1 = View(key_lsh, 0, 3);
    uint1[4] sbox_in2 = View(key_lsh, 4, 7);
    uint1[4] sbox_out1 = s8<sbox_in1>;
    uint1[4] sbox_out2 = s9<sbox_in2>;
    key_lsh[0] = sbox_out1[0];
    key_lsh[1] = sbox_out1[1];
    key_lsh[2] = sbox_out1[2];
    key_lsh[3] = sbox_out1[3];
    key_lsh[4] = sbox_out2[0];
    key_lsh[5] = sbox_out2[1];
    key_lsh[6] = sbox_out2[2];
    key_lsh[7] = sbox_out2[3];
    return key_lsh;
}
