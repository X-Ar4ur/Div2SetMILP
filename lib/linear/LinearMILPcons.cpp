...
//
#include "linear/LinearMILPcons.h"

void LinearMILPcons::wXorC1(std::string path, int inputIdx1, int inputIdx2, int outputIdx, int &dCounter) {
...
void LinearMILPcons::wXorC2(std::string path, int inputIdx1, int inputIdx2, int outputIdx) {
    std::ofstream scons(path, std::ios::app);
    if (!scons){
...
void LinearMILPcons::wAndOrC(std::string path, int inputIdx1, int inputIdx2, int outputIdx) {
    std::ofstream scons(path, std::ios::app);
    if (!scons){
...
void LinearMILPcons::wLinearC1(std::string path, std::vector<int> inputIdx, std::vector<int> outputIdx, int &dCounter,
...
void LinearMILPcons::wLinearC2(std::string path, std::vector<int> inputIdx, std::vector<int> outputIdx, int &dCounter,
                             int branchMin, int branchMax) {
    std::ofstream scons(path, std::ios::app);
    if (!scons){
...
void LinearMILPcons::bThreeForkC(std::string path, int inputIdx, int outputIdx1, int outputIdx2, int &dCounter) {
    std::ofstream scons(path, std::ios::app);
    if (!scons){
        std::cout << "Wrong file path of bThreeForkC ! " << std::endl;
    } else {
        scons << "x" << inputIdx << " + x" << outputIdx1 << " + x" << outputIdx2 << " - d" << dCounter << " >= 0\n";
        scons << "d" << dCounter << " - x" << inputIdx << " >= 0\n";
        scons << "d" << dCounter << " - x" << outputIdx1 << " >= 0\n";
        scons << "d" << dCounter << " - x" << outputIdx2 << " >= 0\n";
        scons << "x" << inputIdx << " + x" << outputIdx1 << " + x" << outputIdx2 << " <= 2\n";
        dCounter++;
    }
    scons.close();
}
...
void LinearMILPcons::bXorC(std::string path, int inputIdx1, int inputIdx2, int outputIdx) {
    std::ofstream scons(path, std::ios::app);
    if (!scons){
        std::cout << "Wrong file path of bXORc ! " << std::endl;
    } else {
        scons << "x" << inputIdx1 << " = x" << inputIdx2 << "\n";
        scons << "x" << inputIdx2 << " = x" << outputIdx << "\n";
    }
    scons.close();
}
...
void LinearMILPcons::bMatrixEntryC12(std::string path, std::vector<std::vector<int>> inputIdx, std::vector<int> outputIdx,
    ...
    for (int i = 0; i < input1.size(); ++i) {
        ...
        // 2023.7.5 所有linear涉及的xor的建模统一用同一个。
        LinearMILPcons::bXorC(path, input1[i], input2[i], output[i]);
    }
    ...
    if (inputIdx.size() > 2) {
        for (int i = 2; i < inputIdx.size(); ++i) {
            ...
            for (int j = 0; j < input1.size(); ++j) {
                ...
                bXorC(path, input1[j], input2[j], output[j]);
            }
            if (i == inputIdx.size() - 1)
    ...
    if (!scons){
        ...
        if (overflows.size() == 0) {
            ...
            bXorC(path, overflows[0], overflows[1], XORout);
            if (overflows.size() > 2) {
...
void LinearMILPcons::bNXorC3(std::string path, std::vector<int> inputIdx, int outputIdx, int &yCounter) {
    std::ofstream scons(path, std::ios::app);
    if (!scons){
...
void LinearMILPcons::bMatrixEntryC3(std::string path, std::vector<std::vector<int>> inputIdx, std::vector<int> outputIdx,
                                  std::vector<int> overflows, std::vector<int> module, int &xCounter, int &yCounter,
                                  int &fCounter) {
    std::vector<int> output;
    for (int i = 0; i < outputIdx.size(); ++i) {
...
void LinearMILPcons::bSboxC1(std::string path, std::vector<int> inputIdx, std::vector<int> outputIdx,
...
void LinearMILPcons::bSboxC2(std::string path, std::vector<int> inputIdx, std::vector<int> outputIdx,
...
void LinearMILPcons::bSboxC3(std::string path, std::vector<int> inputIdx, std::vector<int> outputIdx,
...
void LinearMILPcons::bAddC(std::string path, std::vector<int> inputIdx1, std::vector<int> inputIdx2, std::vector<int> outputIdx,
...
void LinearMILPcons::bAndOrC(std::string path, int inputIdx1, int inputIdx2, int outputIdx) {
    std::ofstream scons(path, std::ios::app);
    if (!scons){
...
void LinearMILPcons::dSboxC1(std::string path, std::vector<int> inputIdx, std::vector<int> outputIdx,
...
void LinearMILPcons::dSboxC2(std::string path, std::vector<int> inputIdx, std::vector<int> outputIdx,
...
void LinearMILPcons::dSboxC3(std::string path, std::vector<int> inputIdx, std::vector<int> outputIdx,
...
void LinearMILPcons::dAddC(std::string path, std::vector<int> inputIdx1, std::vector<int> inputIdx2, std::vector<int> outputIdx,
                         std::vector<std::vector<int>> ineqs, int &dCounter, int &PCounter) {
    int addSize = inputIdx1.size();
    std::ofstream scons(path, std::ios::app);
    if (!scons){
...
void LinearMILPcons::dAndOrC(std::string path, int inputIdx1, int inputIdx2, int outputIdx, int &PCounter) {
    std::ofstream scons(path, std::ios::app);
    if (!scons){
        std::cout << "Wrong file path of bAndC1 ! " << std::endl;
    } else {
